...
class Player(BasePlayer):
    ...
    question4 = models.StringField(
        label='4. 以下敘述何者正確？',
        choices=[
            ('A', '(A) 產品 Y 裡面有 4 顆綠色球（200 法幣）和 1 顆黃色球（0 法幣）（如果其為高品質），或是裡面有 2 顆綠色球（200 法幣）和 3 顆黃色球（0 法幣）（如果其為低品質）。'),
            ('B', '(B) 產品 Y 裡面有 3 顆綠色球（200 法幣）和 2 顆黃色球（0 法幣）（如果其為高品質），或是裡面有 3 顆綠色球（200 法幣）和 2 顆黃色球（0 法幣）（如果其為低品質）。'),
            ('C', '(C) 產品 Y 裡面有 5 顆綠色球（200 法幣）和 0 顆黃色球（0 法幣）（如果其為高品質），或是裡面有 0 顆綠色球（200 法幣）和 5 顆黃色球（0 法幣）（如果其為低品質）。'),
        ],
        widget=widgets.RadioSelect
    )
